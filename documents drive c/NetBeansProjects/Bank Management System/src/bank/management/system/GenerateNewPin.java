...
public class GenerateNewPin extends JFrame implements ActionListener{
    
    JPasswordField pin,repin;
    JButton change,back;
    String Pin;

    GenerateNewPin(String Pin)
    { 
        this.Pin=Pin;
       ...
       add(image);
        ...
        JLabel text=new JLabel("GENERATE  YOUR NEW PIN");
    ...
    public static void main(String args[]) {
        ...
        new GenerateNewPin("").setVisible(true);
    }
}
